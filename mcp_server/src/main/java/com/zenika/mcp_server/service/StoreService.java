...
public class StoreService implements IStoreService {
    ...
    public StoreService(ProductRepository productRepository, OrderRepository orderRepository, UserRepository userRepository) {
...
//                .map(p -> new ProductResponse(p.getId(), p.getName(),p.getMinimumSellingPrice(), p.getTargetSellingPrice(), p.getStock(), p.getDescription()))
                .toList();
